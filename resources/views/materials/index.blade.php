<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            @auth
                <a href="{{ route('materials.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Upload Material
                </a>
            @endauth
        </div>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            @auth
                                <div class="mt-6">
                                    <a href="{{ route('materials.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
                                        Upload Material
                                    </a>
                                </div>
                            @endauth
